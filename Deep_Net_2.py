# -*- coding: utf-8 -*-
"""
Created on Sat Jan 18 19:01:22 2020
...
def DEEP_NETWORK():
    ...
    checkpoint=ModelCheckpoint(os.getcwd()+"\\Deep_Net--Version-1-Counter.h5",monitor='loss', save_best_only=False)
